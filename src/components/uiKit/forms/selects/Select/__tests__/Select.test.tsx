...
import {FormSelectProps, SelectProps} from "../models";
...
const setup = (props: SelectProps<{ label: string; value: string }>) => {
    render(<Select {...props} />);
}

const formSetup = (props: FormSelectProps<{ label: string; value: string }>, onSubmit: typeof jest.fn) => {
...
describe('Select component', () => {
    ...
    it('Should call onChange when user change selected option', () => {
        ...
        expect(mockedOnChange).toHaveBeenCalledWith({label: "A", value: "a"}, {
            action: "select-option",
            name: "my-pretty-select",
            option: undefined
        })
    });
