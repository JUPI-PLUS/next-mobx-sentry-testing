...
const FormParameterNotes = ({ isDisabled, path, schemaPath, className, onClick }: NotesProps) => {
    const {
    ...
    return (
        <div className={`leading-normal my-3 ${className}`}>
            <div className="flex items-center justify-between mb-2">
                <p className="break-words text-xs font-medium text-dark-800">Note</p>
                <TextButton
                    text="Close"
                    size="thin"
                    variant="neutral"
...
export default observer(FormParameterNotes);
